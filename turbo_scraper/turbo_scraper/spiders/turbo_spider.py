...
class TurboSpiderSpider(scrapy.Spider):
    ...
    def parse_item(self, response):
        ...
        car_item.add_xpath('make','//label[@for="ad_make_id"]/following-sibling::span/text()')
        car_item.add_xpath('model','//label[@for="ad_model"]/following-sibling::span/text()')
        car_item.add_xpath('year','//label[@for="ad_reg_year"]/following-sibling::span/text()')
